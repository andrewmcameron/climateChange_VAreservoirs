...
This analysis effectively susbstitutes the station-year for the station-month as the unit of analysis in deriving mblm trends at the station level.
...
write_csv(TMin_mblm, "output_data/annualLongTerm_regressionslope/TMin_mblmAnnual.csv")
```
...
write_csv(TMean_mblm, "output_data/annualLongTerm_regressionslope/TMean_mblmAnnual.csv")
```
...
write_csv(TRange_mblm, "output_data/annualLongTerm_regressionslope/TRange_mblmAnnual.csv")
```
...
write_csv(TMax_mblm, "output_data/annualLongTerm_regressionslope/TMax_mblmAnnual.csv")
```
...
write_csv(DOMin_mblm, "output_data/annualLongTerm_regressionslope/DOMin_mblmAnnual.csv")
```
...
write_csv(DOMean_mblm, "output_data/annualLongTerm_regressionslope/DOMean_mblmAnnual.csv")
```
...
write_csv(DORange_mblm, "output_data/annualLongTerm_regressionslope/DORange_mblmAnnual.csv")
```
...
write_csv(DOMax_mblm, "output_data/annualLongTerm_regressionslope/DOMax_mblmAnnual.csv")
```
...
write_csv(combined_data, "output_data/annualLongTerm_regressionslope/allVariablesCombinbed.csv")
