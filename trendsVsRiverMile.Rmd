...
path <- "~/Desktop/Bukaveckas_WaterLab/climateChange_VAreservoirs/output_data/"
...
ids_combined <- c(ids_moomaw, ids_philpott, ids_claytor, ids_kerrEtal)
...
river_miles <- data.frame(STATION_ID = ids_combined,
                          ...
                          RESERVOIR = c(rep("Moomaw", 4), rep("Philpott", 4), rep("Claytor", 4), rep("Kerr-Leesville-Smith Mountain", 13)))
